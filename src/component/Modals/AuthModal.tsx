  ...
  return (
    <>
      <div
        ...
        onClick={closeModal}
      ></div>
      <div className=" w-[550px]   border border-gray-800 shadow-2xl rounded-lg absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-red  flex justify-center items-center">
