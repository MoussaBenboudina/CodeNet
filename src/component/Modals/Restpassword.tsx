...
type RestpasswordProps = {};

const ResetPassword: React.FC<RestpasswordProps> = () => {
  ...
  return (
    <form
      className="space-y-4 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8 w-[500px] flex flex-col justify-center items-center"
