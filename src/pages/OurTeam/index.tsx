...
const OurTeam: React.FC<OurTeamProps> = () => {
  return (
    <div className="">
      <Navbar />
      <div className="h-screen bg-dark-color-1 text-white flex flex-col justify-center items-center ">
        <h2 className="text-6xl">Our team</h2>
